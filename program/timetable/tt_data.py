...
#TODO: Maybe I can use the Lesson class?
...
#TODO: no longer relevant, the extensions are in the TAG field of block entries
            # Split off possible "+" extension on subject id
            sid0 = sid.split("+", 1)[0]
            i = 0
            aids: List[int] = []
            self.lid2aids[lesson_index] = aids
#TODO: Now only single length entries?
# Could a 1:1 correlation between lid and aid be used now?
#
