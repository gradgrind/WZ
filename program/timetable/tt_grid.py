...
#from qtpy.QtGui import QIcon, QPen, QBrush, QColor#, QPixmap
...
def main(args):
    ...
    for col_header in PERIODS:
        if col_header in BREAKS:
            cols.append(SEPWIDTH)
        cols.append(BOXWIDTH)

    for row_header in DAYS:
        rows.append(BOXHEIGHT)
