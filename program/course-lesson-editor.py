"""
datatable-editor-courses.py

Last updated:  2022-04-03

Gui editor for course/lesson tables.
...
### Messages
PROGRAM_NAME = "Fächerangaben bearbeiten"
...
_EDITING_CELL = (
    "Eine Zelle wird gerade modifiziert.\n"
...
#???
# This module would probably need to be embedded in WZ. It might pop up
# a separate window, but it would be initialized from WZ.
...
from tables.spreadsheet import (
    ...
    read_DataTable_filetypes,
)

### -----

class CourseLessonEditor(QWidget):
    pass
#TODO
...
class _DataTableEditor(DataTableEditor):
    ...
    def open_file(self, filepath):
        ...
        try:
            ...
            config = MINION(DATAPATH("CONFIG/COURSES_NAMES"))
            datatable["__INFO_NAMES__"] = dict(config["INFO_FIELDS"])
            datatable["__FIELD_NAMES__"] = dict(config["TABLE_FIELDS"])
